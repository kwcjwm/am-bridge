...
- reasons: largest-grid:Grid0, transaction-output:TX-BUTTON0ONCLICK-1, wide-schema:5, default-records:1

### ds_testCategory [secondary]
- role: code
- primaryUsage: code-lookup
- salienceScore: 25
- boundComponents: Combo0
- reasons: transaction-output:TX-TESTNAMESELECT-1, input-bound:Combo0,Combo0,Combo0, schema:2, code-lookup-signal
...
- reasons: script-read:1, schema:3, default-records:1, view-state-signal
...
- sqlMapFile: C:\workspace\am-bridge\samples\ScoreRanking_Proj-master\src\main\resources\egovframework\sqlmap\example\sample\EgovSample_Sample_SQL.xml
- tables: score_jew
